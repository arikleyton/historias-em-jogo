class TutorialScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(this.scale.width * 0.5, this.scale.height * 0.16, 'Tutorial da Exploração', {
    ...
    this.add.text(this.scale.width * 0.5, this.scale.height * 0.25, 'Hora de explorar o território', {
      fontFamily: 'Comic Sans MS, Chalkboard SE, sans-serif',
      fontSize: '20px',
      color: '#ffffff',
      stroke: '#000000',
    ...
    const tutorialLines = [
      '1. Use as teclas WASD ou setas para se mover.',
      '2. Descubra a fauna, a flora e os tesouros escondidos na névoa.',
      '3. Não se aproxime das onças nem das cobras.',
      '4. Explore o território e avance em direção à próxima história.'
    ];
    ...
    const btnText = this.add.text(btnBg.x, btnBg.y, 'Explorar', {
      fontFamily: 'Comic Sans MS, Chalkboard SE, sans-serif',
      fontSize: '16px',
      color: '#000000'
