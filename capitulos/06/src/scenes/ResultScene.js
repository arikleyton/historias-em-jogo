...
class ResultScene extends Phaser.Scene {
  ...
  /** Destino do capítulo seguinte dentro do site integrado. */
  static PROXIMO_CAPITULO = '../07/cap07.html';
   ...
   *
   * O botão central segue para o capítulo 7 dentro do mesmo iframe do site.
   */
  ...
  /** Navegação para o capítulo 7, protegida contra clique duplo. */
  goNextChapter() {
